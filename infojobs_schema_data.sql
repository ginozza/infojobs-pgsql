...
('Desarrollador Backend', 'Buscamos un desarrollador backend con experiencia en Go y SQL.', 5, NOW(), 3, 'Open', 49, 1),
('Analista de Seguridad', 'Requerimos un analista de seguridad con experiencia en auditorías y protección de sistemas.', 3, NOW(), 4, 'Open', 50, 2),
('Ingeniero de Software', 'Se busca ingeniero de software con experiencia en proyectos ágiles y en la nube.', 10, NOW(), 2, 'Open', 51, 3),
('Diseñador UI/UX', 'Estamos contratando un diseñador UI/UX con conocimientos en herramientas de diseño como Figma y Sketch.', 2, NOW(), 1, 'Open', 52, 4),
('Gerente de Proyectos', 'Se requiere un gerente de proyectos con experiencia liderando equipos y entregando proyectos a tiempo.', 1, NOW(), 5, 'Open', 53, 5),
('Soporte Técnico', 'Buscamos un técnico de soporte con experiencia en redes y hardware.', 3, NOW(), 2, 'Open', 54, 6),
('Tester de Software', 'Se necesita un tester con experiencia en pruebas manuales y automatizadas.', 4, NOW(), 3, 'Open', 55, 7),
('Desarrollador Frontend', 'Buscamos un desarrollador frontend con experiencia en React y JavaScript.', 6, NOW(), 2, 'Open', 56, 8),
('Especialista en Marketing', 'Se requiere un especialista en marketing con experiencia en SEO y redes sociales.', 2, NOW(), 3, 'Open', 57, 9),
('Administrador de Sistemas', 'Se busca un administrador de sistemas con conocimientos en Linux y administración de servidores.', 4, NOW(), 4, 'Open', 58, 10),
('Desarrollador de Aplicaciones Móviles', 'Buscamos un desarrollador con experiencia en aplicaciones móviles para iOS y Android.', 5, NOW(), 3, 'Open', 59, 11),
('Consultor SAP', 'Se requiere un consultor SAP con experiencia en la implementación de soluciones SAP.', 1, NOW(), 6, 'Open', 60, 12),
('Administrador de Bases de Datos', 'Se busca administrador de bases de datos con experiencia en PostgreSQL y optimización de consultas.', 4, NOW(), 5, 'Open', 49, 13),
('Desarrollador Full Stack', 'Buscamos un desarrollador full stack con conocimientos en Node.js, React y bases de datos relacionales.', 3, NOW(), 4, 'Open', 50, 14),
('Coordinador de Marketing Digital', 'Se requiere un coordinador de marketing digital con experiencia en campañas pagadas y SEO.', 5, NOW(), 3, 'Open', 51, 15),
('Ingeniero en Redes', 'Buscamos ingeniero en redes con experiencia en configuración de redes corporativas y VPN.', 2, NOW(), 4, 'Open', 52, 16),
('Product Owner', 'Se necesita un Product Owner con experiencia en metodologías ágiles y gestión de equipos de desarrollo.', 1, NOW(), 5, 'Open', 53, 17),
('Arquitecto de Software', 'Buscamos un arquitecto de software con experiencia en diseño y escalabilidad de aplicaciones.', 3, NOW(), 6, 'Open', 54, 18),
('Desarrollador de Backend Java', 'Se busca un desarrollador de backend con experiencia en Java y arquitectura de microservicios.', 4, NOW(), 5, 'Open', 55, 19),
('Consultor de Negocios', 'Se requiere un consultor de negocios con experiencia en la optimización de procesos y ERP.', 3, NOW(), 4, 'Open', 56, 20),
('Especialista en SEO', 'Buscamos un especialista en SEO con experiencia en la optimización de motores de búsqueda y análisis de keywords.', 5, NOW(), 3, 'Open', 57, 21),
('Técnico de Redes', 'Se necesita un técnico de redes con experiencia en configuración de switches y routers.', 2, NOW(), 4, 'Open', 58, 22),
('Ingeniero DevOps', 'Buscamos un ingeniero DevOps con experiencia en automatización de infraestructuras y CI/CD.', 4, NOW(), 5, 'Open', 59, 23),
('Consultor en Seguridad Informática', 'Se requiere un consultor con experiencia en auditoría de seguridad y protección de redes.', 3, NOW(), 4, 'Open', 60, 24),
('Gerente de Ventas', 'Buscamos un gerente de ventas con experiencia en la industria retail, para liderar un equipo de ventas en la ciudad de Medellín.', 3, NOW(), 5, 'Open', 49, 1),
('Chef Ejecutivo', 'Se necesita un chef ejecutivo con experiencia en cocina gourmet, liderazgo y creación de menús.', 2, NOW(), 4, 'Open', 50, 2),
('Asesor de Marketing Digital', 'Requerimos un asesor de marketing digital con experiencia en gestión de redes sociales y campañas de publicidad online.', 4, NOW(), 3, 'Open', 51, 3),
('Recepcionista', 'Se busca un recepcionista con habilidades en atención al cliente, manejo de agendas y atención telefónica.', 2, NOW(), 1, 'Open', 52, 4),
('Contador Público', 'Estamos buscando un contador público con experiencia en auditorías y declaraciones fiscales para pequeñas y medianas empresas.', 1, NOW(), 5, 'Open', 53, 5),
('Cajero/a', 'Se necesita un cajero/a con experiencia en atención al cliente y manejo de efectivo y tarjetas.', 6, NOW(), 1, 'Open', 54, 6),
('Gerente de Restaurante', 'Buscamos un gerente de restaurante con experiencia en la industria de alimentos y bebidas, con conocimientos en gestión de personal y operaciones.', 1, NOW(), 6, 'Open', 55, 7),
('Abogado/a Corporativo', 'Se necesita un abogado corporativo con experiencia en asesoría legal a empresas, manejo de contratos y cumplimiento normativo.', 2, NOW(), 4, 'Open', 56, 8),
('Operario/a de Producción', 'Buscamos un operario de producción con experiencia en plantas industriales y manejo de maquinaria pesada.', 10, NOW(), 2, 'Open', 57, 9),
('Asistente Administrativo', 'Se requiere un asistente administrativo con experiencia en gestión de documentos, agendas y atención a clientes internos.', 3, NOW(), 2, 'Open', 58, 10),
('Agente de Viajes', 'Se busca un agente de viajes con experiencia en asesoramiento a clientes, venta de paquetes turísticos y manejo de reservas.', 2, NOW(), 3, 'Open', 59, 11),
('Cocinero/a', 'Se necesita un cocinero/a con experiencia en preparación de platos a la carta en un restaurante de alta gama.', 3, NOW(), 2, 'Open', 60, 12),
('Vendedor/a en Tienda', 'Buscamos un vendedor/a en tienda con experiencia en atención al cliente, ventas y organización del inventario.', 5, NOW(), 1, 'Open', 49, 13),
('Jefe de Logística', 'Requerimos un jefe de logística con experiencia en la gestión de almacenes y distribución de productos a nivel nacional.', 2, NOW(), 4, 'Open', 50, 14),
('Enfermero/a', 'Se necesita un enfermero/a con experiencia en atención hospitalaria, urgencias y gestión de pacientes.', 3, NOW(), 3, 'Open', 51, 15),
('Gerente de Recursos Humanos', 'Buscamos un gerente de recursos humanos con experiencia en selección de personal, capacitaciones y clima organizacional.', 1, NOW(), 5, 'Open', 52, 16),
('Peluquero/a', 'Se busca un peluquero/a con experiencia en cortes de cabello, peinados y atención personalizada a clientes.', 4, NOW(), 2, 'Open', 53, 17),
('Técnico/a de Mantenimiento', 'Se necesita un técnico de mantenimiento con experiencia en reparaciones eléctricas y mecánicas en equipos industriales.', 6, NOW(), 3, 'Open', 54, 18),
('Asistente de Recursos Humanos', 'Requerimos un asistente de recursos humanos con experiencia en manejo de documentos, bases de datos y atención al personal.', 3, NOW(), 2, 'Open', 55, 19),
('Profesor/a de Idiomas', 'Buscamos un profesor de idiomas con experiencia en enseñanza de inglés y otros idiomas a estudiantes de diferentes niveles.', 5, NOW(), 3, 'Open', 56, 20),
('Supervisor/a de Producción', 'Se necesita un supervisor de producción con experiencia en la gestión de líneas de producción en la industria alimentaria.', 4, NOW(), 5, 'Open', 57, 21),
('Farmacéutico/a', 'Buscamos un farmacéutico con experiencia en la dispensación de medicamentos, asesoramiento farmacológico y gestión de inventarios.', 2, NOW(), 4, 'Open', 58, 22);
